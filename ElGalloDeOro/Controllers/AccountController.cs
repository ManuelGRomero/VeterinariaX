...
namespace ElGalloDeOro.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult ClienteMascotas()
        {
        ...
        public ActionResult DeleteConfirmed(string id)
        {
            ...
            usuario.mascotas.Select(a => a.Salida = null);
            usuario.mascotas.Select(a => a.mascotaID = 0);
        ...
        public ActionResult Index()
        {
            ...
            //var vmusuarios = from User in usuarios
            //                 select new VMUserName(User);
